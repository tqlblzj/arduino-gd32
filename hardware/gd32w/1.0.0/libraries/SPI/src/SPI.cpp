...
/* Undefine SPI macro to allow class instance declaration */
#ifdef SPI
    #undef SPI
#endif

SPIClass SPI(DIGITAL_TO_PINNAME(MOSI), DIGITAL_TO_PINNAME(MISO), DIGITAL_TO_PINNAME(SCK), DIGITAL_TO_PINNAME(PIN_SPI_SS));
