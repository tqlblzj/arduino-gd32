 ...
 * Hard_NSS.ino
 *
 * SPI Master with Hardware NSS Example
 *
 * Description:
 * - Demonstrates SPI master mode with hardware NSS (Chip Select) control
 * - Sends data to SPI slave device using three different transfer methods
 * - Displays SPI configuration and transfer results
 *
 * Features:
 * - Hardware NSS control (automatic chip select management)
