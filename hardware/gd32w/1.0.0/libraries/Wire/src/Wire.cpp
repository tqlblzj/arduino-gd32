...
void (*TwoWire::user_onAddrMatch)(void);
...
TwoWire* TwoWire::_activeWire = nullptr;
...
void TwoWire::begin(uint8_t address)
{
    ...
    i2c_init(&_i2c, _i2c.sda, _i2c.scl, ownAddress);
    i2c_address_config(_i2c.i2c, ownAddress, I2C_ADDFORMAT_7BITS);
    ...
    i2c_attach_slave_addr_match_callback(&_i2c, onAddrMatchService);
}
...
void TwoWire::beginTransmission(uint8_t address)
{
    ...
    txAddress = address << 1;
    i2c_address_config(_i2c.i2c, txAddress, I2C_ADDFORMAT_7BITS);
    i2c_master_addressing(_i2c.i2c, txAddress, I2C_MASTER_TRANSMIT);
...
/**
  * @brief  This function must be called in slave Tx event callback or
  *         in master after beginTransmission() and before endTransmission().
...
// called in onRequestService to transmit data to master
uint8_t TwoWire::beginSlaveTransmission(i2c_t *obj, uint8_t *data, uint16_t length)
{
    return i2c_slave_transmit(obj, data, length);
}
...
void TwoWire::onRequestService(void)
{
    ...
    TwoWire* wire = TwoWire::_activeWire;
    wire->beginSlaveTransmission(&(wire->_i2c), &_tx_buffer.buffer[_tx_buffer.tail], wire->_i2c.tx_count);
}

void TwoWire::onAddrMatchService(void)
{
    if(user_onAddrMatch) {
        user_onAddrMatch();
    }
...
void TwoWire::onAddrMatch(void (*function)(void))
{
    user_onAddrMatch = function;
}