...
private:
    ...
    static void (*user_onAddrMatch)(void);
    static void (*user_onReceive)(int);
    static void onRequestService(void);
    static void onAddrMatchService(void);
...
public:
    ...
    uint8_t beginSlaveTransmission(i2c_t *obj, uint8_t *data, uint16_t length);
