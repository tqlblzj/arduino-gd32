 ...
 *
 * Description:
 * - Demonstrates HTTP Basic Authentication for protecting web routes
 * - Protects root path with username/password authentication
 * - Generates SVG logo for authenticated users
 *
 * Features:
 * - Basic Authentication (simple but less secure than Digest Auth)
 ...
 *
 * Note:
 * - Basic Auth sends credentials in base64 encoding (not encrypted)
 * - For production use, consider HTTPS or Digest Authentication
 *
