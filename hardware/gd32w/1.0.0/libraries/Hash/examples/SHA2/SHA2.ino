 ...
 *
 * Description:
 * - Demonstrates SHA2 hash calculation with different output sizes
 * - Tests SHA-224, SHA-256, SHA-384, and SHA-512 variants
 * - Validates hash results against known test vectors
 *
 * Features:
 * - SHA224: 224-bit hash output
 * - SHA256: 256-bit hash output (default)
 * - SHA384: 384-bit hash output
 * - SHA512: 512-bit hash output
 * - Generic SHA2Builder with configurable hash size
 *
