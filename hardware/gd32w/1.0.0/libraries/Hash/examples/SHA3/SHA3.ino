 ...
 *
 * Description:
 * - Demonstrates SHA3 hash calculation with different output sizes
 * - Tests SHA3-224, SHA3-256, SHA3-384, and SHA3-512 variants
 * - Validates hash results against known test vectors
 *
 * Features:
 * - SHA3_224: 224-bit hash output
 * - SHA3_256: 256-bit hash output (default)
 * - SHA3_384: 384-bit hash output
 * - SHA3_512: 512-bit hash output
 * - Generic SHA3Builder with configurable hash size
 *
