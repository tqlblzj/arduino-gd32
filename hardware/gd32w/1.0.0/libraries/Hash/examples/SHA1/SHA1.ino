 ...
 *
 * Description:
 * - Demonstrates SHA1 hash calculation for various input types
 * - Tests String, HEX string, and byte array inputs
 * - Validates SHA1 hash results
 *
 * Note: SHA1 is considered obsolete for security purposes.
 * Use SHA256 or stronger for new applications.
 *
 * Features:
 * - SHA1 hash from String
 * - SHA1 hash from HEX string
 * - SHA1 hash from byte array
...
void setup() {
  ...
  {
    String sha1_str = "31999e21fbc68f504a8f6e5a3e6e37731be5c0cc";
    String password = "gd32";
