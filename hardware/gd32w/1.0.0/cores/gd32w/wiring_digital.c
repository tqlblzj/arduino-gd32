...
void pinMode(uint32_t ulPin, uint32_t ulMode)
{
    ...
    switch(ulMode) {
        case INPUT:
            pin_function(p, PIN_FUN_INPUT);
            break;
        case INPUT_PULLUP:
            pin_function(p, PIN_FUN_INPUT_PULLUP);
            break;
        case INPUT_PULLDOWN:
            pin_function(p, PIN_FUN_INPUT_PULLDOWN);
            break;
        case INPUT_ANALOG:
            pin_function(p, PIN_FUN_INPUT_ANALOG);
            break;
        case OUTPUT:
            pin_function(p, PIN_FUN_OUTPUT);
            break;
        case OUTPUT_OPEN_DRAIN:
            pin_function(p, PIN_FUN_OUTPUT_OPEN_DRAIN);
            break;
        default:
            //Error_Handler();
            break;
