...
HardwareSerial Serial(RX2, TX2, 2);
...
HardwareSerial Serial(RX3, TX3, 3);
...
HardwareSerial Serial(RX4, TX4, 4);
...
HardwareSerial::HardwareSerial(uint8_t rx, uint8_t tx, int uart_index)
{
    ...
    printf("HardwareSerial::HardwareSerial: uart_index=%d, pin_tx=%d, pin_rx=%d\n", uart_index, tx, rx);
}
